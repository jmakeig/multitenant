...
import type { auth_provider, credentials, session } from './types/auth'
import type { customer, create_customer_input } from '../types/customer'

export type { auth_provider, credentials, session } from './types/auth'
export type { customer, create_customer_input } from '../types/customer'
...
export interface pipeline {
	...
	create_session(organization_id: string): session
}
...
export function make_session(organization_id: string): session {
	return {
		organization_id,
